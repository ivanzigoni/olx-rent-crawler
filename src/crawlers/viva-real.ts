            ...
            const propertiesOnPage = await page.evaluate(() => {
                ...
                items.forEach(item => {
                    try {
                        ...
                        const h2 = item.querySelector('h2[data-cy="rp-cardProperty-location-txt"]') as any;
                        let title = null;
                        if (h2) {
                        ...
                        // Street name
                        const street = item.querySelector('p[data-cy="rp-cardProperty-street-txt"]') as any;
                        ...
                        const details: any = {};
                        (item.querySelectorAll('li[data-cy^="rp-cardProperty-"]')).forEach((li: any) => {
                        ...
                        if (priceContainer) {
                            ...
                            const feesP = priceContainer.querySelectorAll('p.text-1-75') as any;
